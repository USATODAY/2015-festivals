...
((__t = ( artist.artist)) == null ? '' : __t) +
'</h2>\n    <p class="iapp-card-info-text"><span class="">' +
((__t = ( artist.genre )) == null ? '' : __t) +
'</span></p>\n    \n</div>\n';
